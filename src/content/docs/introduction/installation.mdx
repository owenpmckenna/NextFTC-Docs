...
implementation 'dev.anygeneric:blazeftc:BLAZE_VERSION'
```
...
<Aside type="tip" title="">
  ...
  />
  Replace the `BLAZE_VERSION` with the latest Blaze version. At the time of writing, this is version `0.1.62`. More up to date info can be found [here](https://github.com/owenpmckenna/blaze_ftc#normal-usage).
</Aside>
